...
public class MailService2 {
	...
	public void sendMail(EmailDTO emailDTO) throws UnsupportedEncodingException {	
		...
		try {
			...
			messageHelper.setSubject(emailDTO.getSubject());//이메일 제목
			messageHelper.setTo(emailDTO.getAddress());//받는 이메일주소
			messageHelper.setText(emailDTO.getContent());//메일내용
